...
class OrganizationRenderer(Renderer):
    ...
    def render(self, view, format):
        ...
        if view == 'widgont':  # a fake 'widgont' (Widget Ontology) view
            if format == 'text/html':
                # redirect to the directory.gov.au representation
                board_uri = 'https://www.directory.gov.au/portfolios/communications-and-arts/australia-council/arts-funding-division/artform-boards/dance-board'
                return redirect(board_uri, code=303)
            else:
